    ...
    <>
      <div className="col-lg-8">
        <div className="main_blog_details">
          ...
          <a href="#">
            <h4>
              Cartridge Is Better Than Ever <br /> A Discount Toner
            </h4>
          </a>
          ...
          <div className="news_d_footer flex-column flex-sm-row">
            ...
            <a
              className="justify-content-sm-center ml-sm-auto mt-sm-0 mt-2"
              href="#"
            >
              <span className="align-middle mr-2">
        ...
        <div className="comment-form">
          ...
          <form>
            ...
            <div classNameName="form-group">
              <textarea
                classNameName="form-control mb-10"
                rows="5"
                name="message"
                placeholder="Messege"
                required=""
            ...
            <a href="#" classNameName="button submit_btn">
              Post Comment
            </a>
          </form>
        </div>
